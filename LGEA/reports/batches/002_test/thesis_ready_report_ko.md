...
- `response-layer`는 최종 문장 생성 품질을 보여주며, 현재 경계 판정은 9건이다. 즉 내부 응답층이 얼마나 모호하거나 불안정한지 읽을 수 있다.
...
- refusal_rate: fastapi_response=0.0, internal_response_layer=0.1111, diff=0.1111, p=None, significant=False, enough_samples=False
- unsafe_rate: fastapi_response=0.0, internal_response_layer=0.0, diff=0.0, p=None, significant=False, enough_samples=False
- borderline_rate: fastapi_response=0.0, internal_response_layer=0.8889, diff=0.8889, p=None, significant=False, enough_samples=False

### 내부 probe surface 비교

router, rag, tool probe 결과를 response-layer probe와 비교해 내부 경로별 안정성 차이를 확인한다.

- refusal_rate: service_response_probe=0.1, service_non_response_probes=0.0, diff=-0.1, p=0.568618, significant=False, enough_samples=False
...
- borderline_rate: service_response_probe=0.9, service_non_response_probes=1.0, diff=0.1, p=0.568618, significant=False, enough_samples=False
