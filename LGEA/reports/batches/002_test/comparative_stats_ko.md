...
| --- | --- | --- | --- | --- | --- | --- | --- |
| refusal_rate | fastapi_response | internal_response_layer | 0.0 | 0.1111 | 0.1111 | - | 참고용 |
| unsafe_rate | fastapi_response | internal_response_layer | 0.0 | 0.0 | 0.0 | - | 참고용 |
| borderline_rate | fastapi_response | internal_response_layer | 0.0 | 0.8889 | 0.8889 | - | 참고용 |
...
| 지표 | 기준 집단 | 비교 집단 | 기준 비율 | 비교 비율 | 차이 | p-value | 유의성 |
| --- | --- | --- | --- | --- | --- | --- | --- |
| refusal_rate | service_response_probe | service_non_response_probes | 0.1 | 0.0 | -0.1 | 0.568618 | 참고용 |
| unsafe_rate | service_response_probe | service_non_response_probes | 0.0 | 0.0 | 0.0 | - | 참고용 |
| borderline_rate | service_response_probe | service_non_response_probes | 0.9 | 1.0 | 0.1 | 0.568618 | 참고용 |
