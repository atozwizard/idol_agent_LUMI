...
- refusal_rate: diff=0.4444, p=None, enough_samples=False
- unsafe_rate: diff=0.0, p=None, enough_samples=False
- borderline_rate: diff=0.5556, p=None, enough_samples=False

### 내부 probe surface 비교

router, rag, tool probe 결과를 response-layer probe와 비교해 내부 경로별 안정성 차이를 확인한다.

- refusal_rate: diff=-0.4, p=0.187986, enough_samples=False
- unsafe_rate: diff=0.0, p=None, enough_samples=False
- borderline_rate: diff=0.4, p=0.187986, enough_samples=False
